...
url = "https://api.p2pquake.net/v2/history?codes=556&limit=100&offset=0"
limit=5    #ここで最新のn件を取得
payload = {"limit":limit, "min_scale":min_scale}
r = requests.get(url, params=payload)
response = requests.get(url, params=payload)#APIの応答を出力
print(response.text)#プリントアウト
data_list = json.loads(r.text) #変更
